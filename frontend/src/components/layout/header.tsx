...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-transparent backdrop-blur-sm border-white/20">
      <div className="container flex h-16 items-center">
        ...
        <nav className="hidden items-center space-x-6 text-sm font-medium md:flex">
          ...
          <Link href="#" className="transition-colors hover:text-white/80 text-white/60">
            About
          </Link>
        </nav>
